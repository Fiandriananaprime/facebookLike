...
const mockPosts = [
  {
    ...
    time: "2h",
    content:
      "Just had an amazing time with friends! Life is beautiful when you're surrounded by the right people. \u{1F31F}",
    image:
  ...
  },
  {
    ...
    time: "5h",
    content:
      "Nature never ceases to amaze me. This sunset was absolutely breathtaking! \u{1F305}",
    image:
  ...
  },
  {
    ...
    time: "8h",
    content:
      "Pizza night is the best night! Who else is craving pizza right now? \u{1F355}",
    image:
  ...
  },
  {
    ...
    time: "12h",
    content:
      "Paradise found! \u{1F3DD}\uFE0F The beach life is calling and I must go.",
    image:
...
function Home() {
  const [user] = useState(JSON.parse(localStorage.getItem("userData") || "null"));
        ...
        <div className="sticky top-20">
          <div className="space-y-2">
            ...
            {sidebarShortcuts.map((item, index) => (
              ...
              >
                <div
                  className={`w-9 h-9 rounded-lg bg-gray-200 flex items-center justify-center ${item.color}`}
                >
      ...
      <main className="md:col-span-6 space-y-4">
        ...
        <Card className="p-4 bg-white">
          <div className="flex gap-3 items-center mb-3">
            ...
            <Input
              placeholder={`What's on your mind, ${profileName.split(" ")[0] || "Utilisateur"}?`}
