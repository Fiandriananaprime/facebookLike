...
const featuredGames = [
  {
    ...
    image: "https://images.unsplash.com/photo-1759701546851-1d903ac1a2e2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlc3BvcnRzJTIwZ2FtaW5nJTIwY29tcGV0aXRpdmV8ZW58MXx8fHwxNzcyNTA5NDcxfDA&ixlib=rb-4.1.0&q=80&w=1080",
    category: "Tournament",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1687713143171-b1ffd531263d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1lJTIwY29udHJvbGxlciUyMGNvbnNvbGV8ZW58MXx8fHwxNzcyNjMzNDQwfDA&ixlib=rb-4.1.0&q=80&w=1080",
    category: "Console",
...
const gameCategories = [
  {
    ...
    image: "https://images.unsplash.com/photo-1617507171089-6cb9aa5add36?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBzZXR1cCUyMHJnYnxlbnwxfHx8fDE3NzI2MDUyMzZ8MA&ixlib=rb-4.1.0&q=80&w=1080",
    category: "PC Gaming",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1661347999665-579bb8f9402d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBnYW1pbmclMjBzbWFydHBob25lfGVufDF8fHx8MTc3MjUzOTY1N3ww&ixlib=rb-4.1.0&q=80&w=1080",
...
const trendingGames = [
  { name: "Battle Royale Legends", icon: "🎮", growth: "+45%" },
  { name: "Space Odyssey", icon: "🚀", growth: "+38%" },
  { name: "Fantasy Quest Online", icon: "⚔️", growth: "+32%" },
  { name: "City Builder Pro", icon: "🏙️", growth: "+28%" },
];
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {featuredGames.map((game) => (
                  <Card key={game.id} className="bg-white overflow-hidden cursor-pointer hover:shadow-lg transition-shadow group">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Time played this week</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
